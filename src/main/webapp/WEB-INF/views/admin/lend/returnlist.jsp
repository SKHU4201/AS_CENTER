		...
		<table class="middle">
			<tr>
				<ul class="nav nav-pills nav-tabs nav-fill">
					...
					<li class="nav-item"><a class="nav-link active " aria-current="page" href="returnlist">반납</a></li>
				...
				<td>
					<div class="input-group mb-3">
						...
						<input type="hidden" name=order value="${ order }"> <input type="text" name="srchText"
							value="${ srchText }" placeholder="검색어를 입력해주세요" class="form-control"
			...
			<tbody>
				<c:forEach var="lend" items="${ lends }">
					<tr align="center">
						...
						<td>
							<form method="post">
								<input type="button" class="btn btn-secondary" name="print" value="인쇄"
