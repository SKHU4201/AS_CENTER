		...
		<table class="table list">
			...
			<tbody>
				<c:forEach var="lend" items="${ lends }">
					<tr data-url
						onclick="window.open('devicelog?detail_no=${lend.detail_no}&device_code=${lend.device_code}','window_name',
						...
						<td>
							<fmt:formatDate pattern="yyyy-MM-dd" value="${ lend.return_date }" />
						</td>
						<td>${ lend.arrears }</td>
