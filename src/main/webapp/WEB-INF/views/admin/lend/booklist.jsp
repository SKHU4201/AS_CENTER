			...
			<tr>
				<td>
					<div class="input-group mb-3">
						...
						<input type="text" name="srchText" value="${ srchText }" placeholder="검색어를 입력해주세요"
			...
			<tbody>
				<c:forEach var="lend" items="${ lends }">
					<tr align="center">
						...
						<td>
							<fmt:formatDate pattern="yyyy-MM-dd hh:mm:ss" value="${ lend.wait_date }" />
						</td>
						<td><a href="approve?lend_no=${ lend.no }"><button type="button" class="btn btn-outline-info"
									data-confirm-approve>승인</button></a></td>
						<td><a href="refuse?lend_no=${ lend.no }"><button type="button" class="btn btn-outline-danger"
									data-confirm-refuse>거절</button></a></td>
