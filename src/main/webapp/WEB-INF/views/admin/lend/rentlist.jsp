				...
				<c:forEach var="lend" items="${ lends }">
					<tr align="center">
						...
						<td><button type="button" class="btn btn-primary" data-bs-toggle="modal"
								data-bs-target="#exampleModal" data-notifyid="${lend.no }">
								대여
							</button>
						</td>
					</tr>
					...
					<table class="rent">
						<form name="rent" method="post" action="rentsave">
							...
							<tr>
								<td>대여시작일: </td>
								<td>
									<fmt:formatDate pattern="yyyy-MM-dd" value="${currenttime}" />
								</td>
							</tr>
							<tr>
								<td>반납예정일: </td>
								<td>
									<fmt:formatDate pattern="yyyy-MM-dd" value="${ end_date }" var="b" />
