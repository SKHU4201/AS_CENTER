		...
		<form method="post">
			<div>
				...
				<div class="type_checkbox" style="display:inline-block;">
					<label><input type="radio" class="pixed" name="type" value=1> 장비 장애</label>
					<label><input type="radio" class="pixed" name="type" value=2> 버그 신고</label>
					<label><input type="radio" class="pixed" name="type" value=3> 기타</label>
				</div>
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td><textarea class="body" id="body" name="body" rows="3" placeholder=" 내용을 적어주세요"></textarea>
							<div id="string_limit">(0 / 1000)</div>
						</td>
					</tr>
					<script>
						$(document)
				...
				<tfoot>
					<tr>
						<td colspan="2"><button type="submit">저장</button><button type="button"
								onclick="location.href='inquiry_list_front'">돌아가기</button></td>
						</td>
					</tr>
				</tfoot>
			</table>
