...
<body>
	...
	<div class="select_middle">
		...
		<table class="select">
			<tr>
				<td><a class="selected_button" id="button1" value="button1" onclick="setColor('button1')"
						href="select_com_laptop">노트북</button></td>
	...
	<div class="select_bottom">
			...
			<tr>
				...
				<td>
					<div class="card" style="width: 18rem;" style="height: 18rem;">
						<img src="/media/device/lg.jpg" class="card-img-top" alt="lg그램" data-bs-toggle="modal"
															...
															<div id="carouselExampleDark"
																...
																<div class="carousel-inner">
																	<div class="carousel-item active"
																		...
																		<img src="/media/device/lg.jpg"
																			class="d-block w-100" alt="...">
																	</div>
																	<div class="carousel-item" data-bs-interval="3000">
																		<img src="/media/device/lg_up.jpg"
																			class="d-block w-100" alt="...">
																	</div>
																	<div class="carousel-item" data-bs-interval="3000">
																		<img src="/media/device/lg_down.jpg"
																			class="d-block w-100" alt="...">
																	</div>
																</div>
		...
		<div class="modal-footer">
			<button class="btn btn-primary" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal"
				data-bs-dismiss="modal">예약신청</button>
		</div>
	</div>
	</div>
	</div>
		...
		<div class="modal-dialog modal-lg modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="device_code" value="COM00001" /><!-- 장비코드명 보내기 -->
					<input type="hidden" name="lend_type" value="1" /> <!-- 장비 타입 (노트북) 보내기 -->
				</div>
				<div class="modal-footer">
												...
												<div id="carouselExampleDark" class="carousel carousel-dark slide"
													...
													<div class="carousel-inner">
														<div class="carousel-item active" data-bs-interval="3000">
															<img src="/media/device/lg.jpg" class="d-block w-100"
																alt="...">
														</div>
														<div class="carousel-item" data-bs-interval="3000">
															<img src="/media/device/lg_up.jpg" class="d-block w-100"
																alt="...">
														</div>
														<div class="carousel-item" data-bs-interval="3000">
															<img src="/media/device/lg_down.jpg" class="d-block w-100"
																alt="...">
														</div>
													</div>
													<button class="carousel-control-prev" type="button"
		...
		<div class="modal-dialog modal-lg modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="device_code" value="COM00002" />
					<input type="hidden" name="lend_type" value="1" />
				</div>
				<div class="modal-footer">
					<button class="btn btn-secondary" data-bs-target="#exampleModalToggle" data-bs-toggle="modal"
						data-bs-dismiss="modal">뒤로가기</button>
		...
		<div class="modal-dialog modal-lg modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="device_code" value="COM00003" />
					<input type="hidden" name="lend_type" value="1" />
				</div>
				<div class="modal-footer">
					<table>
						<tr>
							...
							<td>
							<td><button type="submit" class="btn btn-primary" data-confirm>예약신청완료</button> </td>
							</form>
	...
	<tr>
		...
		<td>
			<div class="card" style="width: 18rem;" style="height: 18rem;">
				<img src="/media/device/14Z950-GT5BL.jpg" class="card-img-top" alt="lg그램" data-bs-toggle="modal"
					href="#exampleModalToggle7">
				<div class="card-body">
											...
											<tr>
												<td colspan="2">
													<div id="carouselExampleDark" class="carousel carousel-dark slide"
														...
														<div class="carousel-inner">
															<div class="carousel-item active" data-bs-interval="3000">
																<img src="/media/device/14Z950-GT5BL.jpg"
																	class="d-block w-100" alt="...">
															</div>
															<div class="carousel-item" data-bs-interval="3000">
																<img src="/media/device/14Z950-GT5BL_up.jpg"
																	class="d-block w-100" alt="...">
															</div>
															<div class="carousel-item" data-bs-interval="3000">
																<img src="/media/device/14Z950-GT5BL_side.png"
																	class="d-block w-100" alt="...">
															</div>
														</div>
														<button class="carousel-control-prev" type="button"
		...
		<div class="modal-dialog modal-lg modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="device_code" value="COM00004" />
					<input type="hidden" name="lend_type" value="1" />
				</div>
				<div class="modal-footer">
					<table>
	...
	<div class="modal-footer">
		<button class="btn btn-primary" data-bs-target="#exampleModalToggle10" data-bs-toggle="modal"
			data-bs-dismiss="modal">예약신청</button>
	</div>
	</div>
	</div>
		...
		<div class="modal-dialog modal-lg modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="device_code" value="COM00005" />
					<input type="hidden" name="lend_type" value="1" />
				</div>
				<div class="modal-footer">
					<table>
