...
<body>
	...
	<div class="select_middle">
		<table class="select">
			<tr>
				<td><a class="select_button" href="select_com_laptop">노트북</button></td>
				<td><a class="selected_button" id="button2" value="button2" onclick="setColor('button2')"
						href="select_com_tablet">태블릿</button></td>
			...
			<tr>
				<td>
					<div class="card" style="width: 18rem;" style="height: 18rem;">
						<img src="/media/device/ipad.jpg" class="card-img-top" alt="lg그램" data-bs-toggle="modal"
							href="#exampleModalToggle">
						<div class="card-body">
							<h5 class="card-title">Apple New iPad WiFi</h5>
						</div>
					</div>
				</td>
				<td>
	...
	<td>
		<div class="card" style="width: 18rem;" style="height: 18rem;">
			<img src="/media/device/tab.jpg" class="card-img-top" alt="lg그램" data-bs-toggle="modal"
				href="#exampleModalToggle3">
			<div class="card-body">
				<h5 class="card-title">삼성 Galaxy Tab 10.1</h5>
			</div>
		</div>
	</td>
	<td>
